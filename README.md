...
This README is placed at the **root of the GitHub repository**.  
The main project files and dashboard images are inside:

```text
audit_workforce_dashboard_colab/audit_workforce_dashboard/
```

That is why the screenshot links use this full relative path:

```text
audit_workforce_dashboard_colab/audit_workforce_dashboard/images/
```
...
![Executive Overview](audit_workforce_dashboard_colab/audit_workforce_dashboard/images/1.jpeg)
...
![Transaction Audit Overview](audit_workforce_dashboard_colab/audit_workforce_dashboard/images/3.jpeg)

![Transaction Audit Table](audit_workforce_dashboard_colab/audit_workforce_dashboard/images/4.jpeg)

![Price Deviation Chart](audit_workforce_dashboard_colab/audit_workforce_dashboard/images/5.jpeg)
...
![Top Risk Items](audit_workforce_dashboard_colab/audit_workforce_dashboard/images/2.jpeg)
...
![Vendor Risk Analysis](audit_workforce_dashboard_colab/audit_workforce_dashboard/images/6.jpeg)
...
![Workload Forecast Summary](audit_workforce_dashboard_colab/audit_workforce_dashboard/images/8.jpeg)

![Workload Forecast Table](audit_workforce_dashboard_colab/audit_workforce_dashboard/images/9.jpeg)

![Pressure Score by Employee](audit_workforce_dashboard_colab/audit_workforce_dashboard/images/10.jpeg)

![Expected Hours vs Tasks](audit_workforce_dashboard_colab/audit_workforce_dashboard/images/11.jpeg)
...
![Auto Generated Query Message](audit_workforce_dashboard_colab/audit_workforce_dashboard/images/12.jpeg)
...
![Data Schema and Ethics Notes](audit_workforce_dashboard_colab/audit_workforce_dashboard/images/13.jpeg)
...
```text
audit-workforce-intelligence-dashboard/
├── README.md
└── audit_workforce_dashboard_colab/
...
```bash
git clone https://github.com/sadianeeha019/audit-workforce-intelligence-dashboard.git
cd audit-workforce-intelligence-dashboard/audit_workforce_dashboard_colab/audit_workforce_dashboard
```
...
**Sadia Sabrin Neha**  
AI, Data Analytics, and Business Intelligence Enthusiast

GitHub: `https://github.com/sadianeeha019`
